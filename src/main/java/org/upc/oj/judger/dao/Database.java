...
public class Database {
   ...
   public int Connect2Database() throws SQLException {
   ...
   public List<TestIOFile> GetTestByQid(String Qid) throws SQLException {
   ...
   public Boolean ShutDownCon() throws SQLException {
       statement.close();
       con.close();
